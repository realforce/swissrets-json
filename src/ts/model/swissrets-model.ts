 ...
 *
 * Property is located fa-to-face with another property.
 *
 * Has an attic.
 *
 * Balcony available.
 ...
 *
 * Defines if this additional offer price is included into the main rent/buy price.
 *
 * Defines if this additional offer is optional. If it's mandatory - a client can't decline
 * it.
 */
...
export  interface  PropertyCharacteristics {
    ...
    areaNwf?: number;
    /**
     * Property ground area in m²
     */
    areaPropertyGround?: number;
    /**
    ...
    videoSecurity?:                string;
    /**
     * What you can see out of windows of the property.
     */
    view?:  View[];
    vinyl?: string;
    /**
...
export  interface  SwissRetsSchemaJson {
    ...
    comment?: Comment[];
    /**
     * Habitable area in m² per each space unit.
     */
    habitableArea?: number;
    /**
     * Space is habitable.
     */
    isHabitable: ApplicableType;
    name:        Name;
    /**
     * How many such spaces there are in the property.
     */
    quantity:    number;
    surfacePPE?: number;
    /**
     * Usable area in m² per each space unit.
     */
    usableArea?: number;
    /**
     * Weighting of each space unit, m².
     */
    weighting?: number;
}

/**
 * One for each language, a set of language specific comments, related to the space.
 */
...
export enum Name {
    AccommodationS = "Accommodation(s)",
    AmericanKitchen = "American kitchen",
    AngleKitchen = "Angle kitchen",
    ApartmentS = "Apartment(s)",
    ArcadeS = "Arcade(s)",
    AtticS = "Attic(s)",
    BalconyIes = "Balcony(ies)",
    BarnS = "Barn(s)",
    BasementS = "Basement(s)",
    BathroomS = "Bathroom(s)",
    BathroomSLavatoryIes = "Bathroom(s) / Lavatory(ies)",
    BedroomS = "Bedroom(s)",
    BikeStorageRoomS = "Bike storage room(s)",
    Boathouse = "Boathouse",
    BoxEs = "Box(es)",
    CabinS = "Cabin(s)",
    CafeteriaS = "Cafeteria(s)",
    CarShelter = "Car shelter",
    CarnotzetS = "Carnotzet(s)",
    CellarS = "Cellar(s)",
    ClosetS = "Closet(s)",
    Combles = "Combles",
    CorridorS = "Corridor(s)",
    CourtyardS = "Courtyard(s)",
    CoveredBalcony = "Covered balcony",
    CoveredTerrace = "Covered terrace",
    CupboardS = "Cupboard(s)",
    DiningRoomKitchen = "Dining room / kitchen",
    DiningRoomS = "Dining room(s)",
    Disponible = "Disponible",
    DoubleReceptionRoomS = "Double reception room(s)",
    EntranceS = "Entrance(s)",
    EquippedKitchen = "Equipped kitchen",
    ExerciseRoomS = "Exercise room(s)",
    Exterior = "Exterior",
    ExteriorSwimmingPoolS = "Exterior swimming pool(s)",
    Galetas = "Galetas",
    Gallery = "Gallery",
    GarageS = "Garage(s)",
    GarbageRoomS = "Garbage room(s)",
    GardenS = "Garden(s)",
    GardenShed = "Garden shed",
    GardenShelterS = "Garden shelter(s)",
    GroundFloor = "Ground floor",
    HallS = "Hall(s)",
    HallwayS = "Hallway(s)",
    HammamS = "Hammam(s)",
    HomeCinemaS = "Home cinema(s)",
    HouseS = "House(s)",
    IndoorParkingS = "Indoor parking(s)",
    IndoorSwimmingPoolS = "Indoor swimming pool(s)",
    Jacuzzi = "Jacuzzi",
    ...
    LandS = "Land(s)",
    LandingS = "Landing(s)",
    LaundryRoomS = "Laundry room(s)",
    LavatoryIes = "Lavatory(ies)",
    LibraryIes = "Library(ies)",
    LinenRoomS = "Linen room(s)",
    LivingRoomS = "Living-room(s)",
    LivingRoomSDiningAreaS = "Living room(s)/dining area(s)",
    LoftS = "Loft(s)",
    LoggiaS = "Loggia(s)",
    LowerGroundFloor = "Lower ground floor",
    MaidSRoomS = "Maid's room(s)",
    MaidSStudioS = "Maid's studio(s)",
    MaintenanceRoomS = "Maintenance room(s)",
    MasterBedroomS = "Master bedroom(s)",
    MeetingRoomS = "Meeting room(s)",
    MezzanineS = "Mezzanine(s)",
    NightclubS = "Nightclub(s)",
    NotUsed = "Not used",
    OpenKitchen = "Open kitchen",
    OpenSpaceS = "Open space(s)",
    OtherS = "Other(s)",
    OutbuildingS = "Outbuilding(s)",
    OutdoorParkingS = "Outdoor parking(s)",
    OutdoorRoom = "Outdoor room",
    PanicRoomS = "Panic room(s)",
    Parcel = "Parcel",
    ParkS = "Park(s)",
    ParkingS = "Parking(s)",
    PatioS = "Patio(s)",
    PlayRoomS = "Play room(s)",
    PoolHouseS = "Pool house(s)",
    PrayerRoomS = "Prayer room(s)",
    ReceptionRoomS = "Reception room(s)",
    ReductedBalcony = "Reducted balcony",
    RoofTopTerrace = "Roof top terrace",
    RoomS = "Room(s)",
    RootCellarS = "Root cellar(s)",
    SaunaS = "Sauna(s)",
    SemiEquippedKitchen = "Semi-equipped kitchen",
    ShedS = "Shed(s)",
    ShopS = "Shop(s)",
    ShowerRoomS = "Shower room(s)",
    ShowerRoomSLavatoryIes = "Shower room(s)/ Lavatory(ies)",
    SkiLocker = "Ski locker",
    SkiStorageRoomS = "Ski storage room(s)",
    SolariumS = "Solarium(s)",
    Spa = "Spa",
    SpaceType = "Space type",
    StairS = "Stair(s)",
    StockroomS = "Stockroom(s)",
    StorageRoomS = "Storage room(s)",
    ...
    WarehouseS = "Warehouse(s)",
    WatchtowerS = "Watchtower(s)",
...
export  interface  PropertyPrices {
    /**
     * Additional monthly or annual charges.
     */
...
export  interface  AdditionalCharges {
    /**
     * Annual charges for the property
     */
    annual?: number;
    /**
     * Annual charges for the property commercial expenses per square meter.
     */
    commercialExpenses?: number;
    /**
     * Monthly charges for the property heating.
     */
    heating?: number;
    /**
     * Defines if additional charges are included into the main rent/buy price.
     */
    includedInPrice?: ApplicableType;
    /**
     * Monthly charges for the property PPE.
     */
    ppe?: number;
    [property: string]: any;
}
